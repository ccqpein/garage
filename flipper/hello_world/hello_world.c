// this file just copy from
// https://github.com/DroomOne/Flipper-Plugin-Tutorial/blob/main/hello_world.c
...
static void render_callback(Canvas* const canvas, void* ctx) {
  ...
  canvas_draw_str_aligned(canvas, plugin_state->x, plugin_state->y, AlignRight,
                          AlignBottom, "Hello World");

  release_mutex((ValueMutex*)ctx, plugin_state);
}

static void input_callback(InputEvent* input_event,
