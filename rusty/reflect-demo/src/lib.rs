                ...
                fn fmt() {
                    ...
                    impl _reflect::runtime::RuntimeFunction for fmt {
                        fn SELF(self) -> _reflect::Function {
                            ...
                            _reflect::runtime::RuntimeType::SELF(Debug)
                                .get_function("fmt", sig)
                        }
                    }
                    impl fmt {
                        pub fn INVOKE(
                ...
                fn debug_struct() {
                    ...
                    impl _reflect::runtime::RuntimeFunction for debug_struct {
                        fn SELF(self) -> _reflect::Function {
                            ...
                            sig.add_input(
                                _reflect::runtime::RuntimeType::SELF(str).reference(),
                            );
                            sig.set_output(
                ...
                fn field() {
                    ...
                    impl _reflect::runtime::RuntimeFunction for field {
                        fn SELF(self) -> _reflect::Function {
                            ...
                            sig.add_input(
                                _reflect::runtime::RuntimeType::SELF(Debug).reference(),
                            );
                            sig.set_output(
                                _reflect::runtime::RuntimeType::SELF(DebugStruct)
                                    .reference_mut(),
